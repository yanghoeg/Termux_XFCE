...
# proot_install <distro>
#   설명: proot-distro 설치 (rootfs 생성)
#   인자: $1 = distro 이름 (ubuntu, archlinux 등)
#   반환: 0=성공, 1=실패
# proot_install() { ... }

# proot_remove <distro>
#   설명: proot-distro 제거 (rootfs 삭제)
#   인자: $1 = distro 이름
#   반환: 0=성공, 1=실패
# proot_remove() { ... }

# -----------------------------------------------------------------------------
# proot 내부 root 권한 패키지 관리 (사용자 생성 전 단계용)
# -----------------------------------------------------------------------------

# proot_pkg_install_root <package...>
#   설명: proot 내부에 root 권한으로 패키지 설치 (sudo 없이)
#   용도: 사용자 생성 전 sudo 자체를 설치하는 등 부트스트랩 단계
#   인자: $@ = 패키지 이름 목록
#   반환: 0=성공, 1=실패
# proot_pkg_install_root() { ... }

# proot_pkg_update_root
#   설명: proot 내부에 root 권한으로 패키지 목록 업데이트 + 업그레이드
#   용도: 사용자 생성 전 초기 업데이트
#   인자: 없음
#   반환: 0=성공, 1=실패
# proot_pkg_update_root() { ... }
